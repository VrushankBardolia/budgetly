...
class CategoriesTab extends StatelessWidget {
          ...
          ElevatedButton(
            onPressed: () async {
              if (nameController.text.isNotEmpty &&
                ...
                try {
                  await Get.find<CategoryController>().addCategory(
                    nameController.text,
        ...
        appBar: AppBar(
          ...
          actions: [
            Tooltip(
              ...
              child: Text(
                "${categoryController.categoryCount.toString()}/10",
                style: GoogleFonts.plusJakartaSans(color: Colors.white),
              ),
            ),
          ],
        ),
        body: _buildBody(categoryController),
        floatingActionButton: categoryController.categoryCount >= 10
            ? null
  ...
  Widget _buildBody(CategoryController categoryController) {
    ...
    final belowPadding = categoryController.categoryCount == 10 ? 16 : 100;
