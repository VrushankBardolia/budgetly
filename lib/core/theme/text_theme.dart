...
TextStyle boldText(double size, {Color color = AppColors.white, double? height}) {
  return GoogleFonts.plusJakartaSans(fontSize: size, fontWeight: FontWeight.bold, color: color, height: height);
}

TextStyle semiBoldText(double size, {Color color = AppColors.white, double? height}) {
  return GoogleFonts.plusJakartaSans(fontSize: size, fontWeight: FontWeight.w600, color: color, height: height);
}
